...
from volatility_regime import classify_volatility_regime, normalize_vol_decimal, schwab_iv_percent_to_decimal
    ...
    *,
    ...
    try:
        ...
        if mc_context_error is not None:
            ...
            iv = schwab_iv_percent_to_decimal(inp.iv_level)
            if iv is None and inp.iv_level is not None:
