...
- [ ] **§3 Market data + state** — `market_context.py`, `market_state.py`, `math_snapshot_derive.py`. Prior `86d4bc4` fixes kept; full-scope AST re-walk `0b4e0fb` (38 rows). SHA: __________
