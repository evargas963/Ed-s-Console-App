...
Machine master: `governance/requirement_tree.json`. Derived proof: `reports/requirement_proof_latest.json`. Defect ledger: `governance/root_cause_log.md`. A child PASS never closes a parent.
