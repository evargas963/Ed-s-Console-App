...
- [ ] **AUDIT-CURSOR-DATA-UI-SLICE-2026-05-27** — **Claude full Read audit** of Cursor commits `f078593` + `c0770f6` on `feature/institutional-key-levels`. Handoff: `ACTIVE_PROGRAM.md` §Claude audit handoff. **Closes when:** Claude sign-off with file:line citations + enumerated FINDs (if any) land as OPEN_ITEMS rows or same-turn fixes.
