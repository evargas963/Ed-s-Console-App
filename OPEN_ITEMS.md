...
- [x] **FIND-WIRE1-1-CALLCARD** @ `<CALLCARD-SHA>` — `signal_types.TheCall.r_units: Optional[float] = None` (completes FIND-WIRE1-1 / FIND-SERVERPY-11 producer chain at CallCard). Tests: `test_stack_wire_1_v1.py::test_r_units_none_propagates_end_to_end`, `test_action10_6_thecall_validation_defaults.py::test_thecall_r_units_defaults_none_not_zero`.
