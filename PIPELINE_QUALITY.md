> **Classification:** Operator Runbook | **Scope:** TQM checkpoints from live ingest to model-ready tables (served at `/guide/pipeline-quality`; restored from the archive 2026-09-05, RC-520).
