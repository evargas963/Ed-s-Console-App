> **Classification:** Thin pointer | **Scope:** Pointer to AGENTS.md. `ACTIVE_PROGRAM.md` is historical evidence only (zero work authority).

# MEMORY.md — thin pointer (Phase 1c)

**Portable rules live in [`AGENTS.md`](AGENTS.md).**
`ACTIVE_PROGRAM.md` is a historical pointer with zero work authority.
...
**Unresolved-work / execution-priority state** is always the sole master
`ED_CONSOLE_INSTITUTIONAL_TRUTH_AND_REMEDIATION_V1_MASTER_CHECKLIST.md`,
not this file and not `ACTIVE_PROGRAM.md`.
