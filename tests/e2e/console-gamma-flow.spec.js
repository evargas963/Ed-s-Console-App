...
async function setup(page, ctx) {
  ...
  await page.route('**/api/**', (route, request) => {
    ...
    else if (url.includes('/api/options/gamma-surface')) body = { ticker: 'SPY', available: true, spot: 100, source: 'terrain_live_cache', live: true, stale: false, expirations: [{ expiry: '2026-09-11', dte: 2 }], strikes: [100], cells: [{ strike: 100, gex: [1], contracts: [{ call: 'C100', put: 'P100' }] }] };
