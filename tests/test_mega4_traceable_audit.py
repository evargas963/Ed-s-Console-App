...
MEGA4_ROW_COUNT = 1044  # +1 resolve_live_v2_calibration_tail_action (calibration/v2_live_logging.py) — pre-existing inventory gap in uncommitted live-logging work, closed 2026-07-19 (prior: 1038)
