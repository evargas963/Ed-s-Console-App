...
def test_producer_gates_projection_on_demand(monkeypatch):
    ...
    # produced it. (The retired last-valid refill used to stamp gamma_available /
    # cells_with_data / cells_with_oi_but_invalid_greeks on top; the stub below carries only
    # what this cycle's own projection produced.)
