"""volatility_regime chunk-1: I-01 contracts for unknown fallback and missing canonical spot."""
...
def test_classify_vol_regime_unknown_not_trade_permissive():
    out = classify_volatility_regime(
        _minimal_inp(realized_vol=None, atr=None, iv_level=None, vix_level=None),
