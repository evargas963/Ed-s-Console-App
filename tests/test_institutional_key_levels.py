...
def test_inflections_and_oi_center_stay_analytics_not_structural_levels():
    ...
    # The fixture's in-the-money 734-739 calls report delta 1.0 / gamma 0.0 -- Schwab's
    # American-exercise pricing, used as reported (2026-09-26: never on European $SPX, 31,501
    # in-the-money vs 1 out-of-the-money on American contracts). The 748 put's gamma -91965 is
    # impossible, so strike 748 is excluded whole.
    assert rows[0].gamma_inflection == 749.0
