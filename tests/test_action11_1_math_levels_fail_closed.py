...
def test_key_level_strikes_with_oi_skips_one_sided_oi():
    exposures = {
        100.0: {"call_oi": 100.0},
        105.0: {"call_oi": 50.0, "put_oi": 50.0},
    }
    assert key_level_strikes_with_oi(exposures) == [105.0]
...
def test_compute_max_pain_ignores_strike_when_oi_present_but_mult_missing():
    ...
    assert compute_max_pain(exposures) == 105.0
