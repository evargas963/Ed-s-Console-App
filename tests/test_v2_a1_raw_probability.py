...
def test_dominant_probability_byte_equivalent_to_legacy_for_representative_inputs():
    ...
    cases = [
        ...
        ({"fusion_available": True, "canonical_provenance": "bayesian_fusion", "stack_directional_authorized": True, "fusion_dominant_prob": "0.87654", "dominant_prob": 0.1}, 0.8765),
        ...
        # Fusion setup present but directional authorization absent -> fall through
        ({"fusion_available": True, "canonical_provenance": "bayesian_fusion", "fusion_dominant_prob": 0.9, "dominant_prob": 0.11119}, 0.1112),
        # Fusion authoritative but fusion_dominant_prob INVALID -> fall through to dominant_prob
        ({"fusion_available": True, "canonical_provenance": "bayesian_fusion", "stack_directional_authorized": True, "fusion_dominant_prob": "bad", "dominant_prob": 0.34567}, 0.3457),
