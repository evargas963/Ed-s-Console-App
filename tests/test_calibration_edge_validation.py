...
def test_edge_validation_stub_fails_strict_alpha_same_as_always_long(tmp_path: Path) -> None:
    """CI stub: dominant canonical class ties to 'up' -> effective signal equals always-long;
    strict EV gate fails. Guards against analyze_edge silently passing a strict directional-
