...
- [ ] **OPS-FULL-SUITE-STAMP** — operator host: fresh `node scripts/run-pytest-full.mjs` (RC-535 output sink) after the E2E run. Prior full run 2026-07-20: 4237 passed / 4 failed; the 3 code failures are fixed but the 4240/4241 tally is UNVERIFIED until a fresh complete run (Cursor veracity audit: "not re-proven").
