...
| `gamma_wall`, `delta_wall`, `pin_rail` | Exposure buckets derived from option chain Greeks, **`openInterest`**, and governed underlying quote | Schwab provides contracts, not structural wall selection. | `math_levels.py` wall builders |
