...
| Gate | PASS if |
|------|---------|
| **G1 — Authority** | Every binding numeric or policy value in `PHASE_PLAN_INFRASTRUCTURE.md` §§6–14, including §10 governance-event decisions, exists in `OPERATOR_DECISION_REGISTER.md` with no **UNKNOWN** for any field the plan asserts. Plan does not claim “exact” ahead of register. |
...
| Run date | 2026-05-01 |
| Commit / PR | f423c6d |
| G1 | ☑ PASS — register **O-01–O-19** approved; `PHASE_PLAN_INFRASTRUCTURE.md` §§6–14 (including §10 governance-event decisions) binding values aligned with register; no UNKNOWN where asserted |
