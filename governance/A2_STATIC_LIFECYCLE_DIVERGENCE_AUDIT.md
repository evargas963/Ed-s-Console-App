...
| IV-crush handler | `neither` | Future IV path / selected contract IV / threshold policy | Future advisory exit or warning event | false | true | `a2_lifecycle_iv_crush_handler_not_implemented` | No static lifecycle rule currently fires on IV crush. This remains a named lifecycle gap. |
