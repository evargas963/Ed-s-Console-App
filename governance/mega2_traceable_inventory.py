...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("math_exposure_core.py", 32, "_charm_skip_is_uniform_steady_state", "NONE", None, (), None, "No market-field derivation: parses charm skip histogram for uniform steady-state log demotion."),
    Mega2TraceableDerivation("math_exposure_core.py", 73, "charm_compute_unavailable_log_level", "NONE", None, (), None, "No market-field derivation: tri-state logging for charm quality-gate withhold (DEBUG/INFO/WARNING)."),
