...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("math_exposure.py", 52, "_of_direction", "NONE", None, (), None, "No market-field derivation: Direction label from a single primitive scalar."),
    Mega2TraceableDerivation("math_exposure.py", 80, "_book_direction", "NONE", None, (), None, "No market-field derivation: Book imbalance label bands."),
    ...
    Mega2TraceableDerivation("math_levels.py", 149, "_pin_peak_to_median_ratio", "DERIVED", None, ("math_exposure_core.py:net_gex_dollars_at_strike", "math_exposure_core.py:bucket_metric",), None, "Measurement: |net GEX$| at the analytics peak vs median strike. Not a High/Med/Low score."),
    Mega2TraceableDerivation("math_levels.py", 1133, "unique_strike_count", "SCHWAB_LEAF", 'chains.*.strikePrice', (), None, "Distinct finite strikePrice coverage count, not a score."),
    Mega2TraceableDerivation("math_levels.py", 1148, "prefer_wider_level_chain", "DERIVED", None, ("math_levels.py:unique_strike_count",), None, "Chooses live vs same-session morning_full archive when the live book is too narrow."),
    Mega2TraceableDerivation("math_levels.py", 1272, "displayable_trusted_level", "ALLOWLISTED", None, (), 'mega2_display_formatter', "TRUSTED-confidence display gate; no new market-field derivation."),
    Mega2TraceableDerivation("math_levels.py", 1287, "level_at_captured_edge", "ALLOWLISTED", None, (), 'mega2_internal_helper', "Window-edge geometry predicate; no new market-field derivation."),
    Mega2TraceableDerivation("math_levels.py", 1311, "displayable_interior_trusted_level", "ALLOWLISTED", None, (), 'mega2_display_formatter', "TRUSTED plus interior-of-window display gate."),
    Mega2TraceableDerivation("math_levels.py", 1326, "displayable_gamma_flip", "ALLOWLISTED", None, (), 'mega2_display_formatter', "Operator-visible flip number; delegates to the TRUSTED display gate."),
    ...
    Mega2TraceableDerivation("order_flow_engine.py", 844, "_compute_book_tape_batch_geometry", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book+tape batch geometry (RC-456; not absorption)."),
    ...
    Mega2TraceableDerivation("order_flow_engine.py", 1100, "OrderFlowEngine.compute", "DERIVED", None, ("order_flow_live_state.py:get_content_for_symbol", "order_flow_engine.py:compute_book_microstructure"), None, "Public OF engine entry; reads canonical primitives. Composite score/verdict RETIRED (RC-454)."),
    Mega2TraceableDerivation("order_flow_engine.py", 799, "_weighted_mean_present", "NONE", None, (), None, "Generic present-weighted mean helper; no market-field derivation of its own."),
    ...
    Mega2TraceableDerivation("order_flow_engine.py", 576, "_microstructure_structural", "DERIVED", None, ("order_flow_engine.py:_book_side_depth_total", "order_flow_engine.py:_microprice",), None, "Structural book microstructure: depth totals, imbalance, microprice, slope, concentration. Median-times-3 size-outlier candidates retired (RC-467)."),
    ...
    Mega2TraceableDerivation("order_flow_live_state.py", 93, "_get_receive_log", "NONE", None, (), None, "No market-field derivation: local receive-log deque accessor."),
    Mega2TraceableDerivation("order_flow_live_state.py", 252, "clear_all_live_state", "NONE", None, (), None, "No market-field derivation: session/reconnect buffer reset."),
    Mega2TraceableDerivation("order_flow_live_state.py", 262, "_clear_all_session_state_unlocked", "NONE", None, (), None, "No market-field derivation: locked buffer-clear helper."),
    Mega2TraceableDerivation("order_flow_live_state.py", 278, "forget_unsubscribed_symbols", "NONE", None, (), None, "No market-field derivation: drop live state for symbols leaving the stream set."),
    Mega2TraceableDerivation("order_flow_live_state.py", 349, "get_receive_log", "NONE", None, (), None, "No market-field derivation: copies local receive_seq log; not a native trade id."),
    ...
    Mega2TraceableDerivation("order_flow_streaming.py", 488, "bind_production_level_one_handler", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Production LEVELONE handler faucet: add_level_one_equity_handler + push_level_one (same as _run_stream_loop)."),
    Mega2TraceableDerivation("order_flow_streaming.py", 494, "bind_production_level_one_handler._handler", "NONE", None, (), None, "No market-field derivation: nested handler; parent row owns stream ingest."),
    Mega2TraceableDerivation("order_flow_streaming.py", 508, "subscribe_production_level_one", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Production StreamClient.level_one_equity_subs (same subscribe as the live loop)."),
    Mega2TraceableDerivation("order_flow_streaming.py", 516, "collect_level_one_receipts", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Authenticated LEVELONE collect via the production StreamClient path."),
    Mega2TraceableDerivation("order_flow_streaming.py", 538, "collect_level_one_receipts._on_item", "NONE", None, (), None, "No market-field derivation: receipt capture nested in collect_level_one_receipts."),
    Mega2TraceableDerivation("order_flow_streaming.py", 541, "collect_level_one_receipts._run", "NONE", None, (), None, "No market-field derivation: async runner nested in collect_level_one_receipts."),
    Mega2TraceableDerivation("order_flow_streaming.py", 571, "start_order_flow_stream", "DERIVED", None, ("order_flow_live_state.py:get_content_for_symbol",), None, "Delegates to Schwab transport producers for start_order_flow_stream."),
