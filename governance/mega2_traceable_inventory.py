...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("order_flow_streaming.py", 452, "_contract_matches_underlying", "NONE", None, (), None, "No market-field derivation: OSI-prefix compare of an already-selected vendor contract symbol against the active underlying."),
    Mega2TraceableDerivation("order_flow_streaming.py", 461, "_ensure_default_option_contract_for_ticker", "NONE", None, (), None, "No market-field derivation: requests the server-owned default vendor contract; pick lives in app.options.default_contract."),
