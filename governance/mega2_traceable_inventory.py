...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 837, "OrderFlowEngine.compute", "DERIVED", None, ("order_flow_live_state.py:get_content_for_symbol",), None, "Public OF engine entry; composes sub-metrics."),
    ...
    Mega2TraceableDerivation("order_flow_live_state.py", 28, "is_rth_open", "ALLOWLISTED", None, (), 'mega1_session_calendar', "No Schwab market-field derivation in function body."),
    Mega2TraceableDerivation("order_flow_live_state.py", 44, "OrderFlowState.__init__", "NONE", None, (), None, "No market-field derivation: allocates one isolated state container and lock."),
    Mega2TraceableDerivation("order_flow_live_state.py", 67, "OrderFlowState._get_book", "NONE", None, (), None, "No market-field derivation: bounded book-deque accessor owned by the canonical state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 73, "OrderFlowState._get_tape", "NONE", None, (), None, "No market-field derivation: bounded tape-deque accessor owned by the canonical state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 79, "OrderFlowState._get_receive_log", "NONE", None, (), None, "No market-field derivation: local receive-log deque accessor; not a native trade id."),
    Mega2TraceableDerivation("order_flow_live_state.py", 85, "OrderFlowState.push_book", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Canonical state transition for a Schwab stream book observation."),
    Mega2TraceableDerivation("order_flow_live_state.py", 104, "OrderFlowState.push_level_one", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Canonical partial-field, freshness, and tape transition for a Schwab LEVEL_ONE observation."),
    Mega2TraceableDerivation("order_flow_live_state.py", 214, "OrderFlowState.get_content_for_symbol", "DERIVED", None, ("order_flow_live_state.py:OrderFlowState.push_level_one", "order_flow_live_state.py:OrderFlowState.push_book",), None, "Canonical engine-facing content derived from one isolated state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 227, "OrderFlowState.get_l1_stream_input_probe", "ALLOWLISTED", None, (), 'mega1_l1_sse_counters', "Cheap L1 gate snapshot from the canonical state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 243, "OrderFlowState.clear_all", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears one state instance so prior-session identity cannot bind a new session."),
    Mega2TraceableDerivation("order_flow_live_state.py", 248, "OrderFlowState._clear_all_session_state_unlocked", "NONE", None, (), None, "No market-field derivation: lock-held state-container wipe helper."),
    Mega2TraceableDerivation("order_flow_live_state.py", 263, "OrderFlowState.forget_unsubscribed_symbols", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears canonical state for symbols leaving a subscription set."),
    Mega2TraceableDerivation("order_flow_live_state.py", 271, "OrderFlowState.get_receive_log", "NONE", None, (), None, "No market-field derivation: copies the local receive-sequence log."),
    Mega2TraceableDerivation("order_flow_live_state.py", 279, "OrderFlowState.clear_symbol", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears every canonical state component for one symbol."),
    Mega2TraceableDerivation("order_flow_live_state.py", 295, "OrderFlowState.get_stream_volume", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads the latest positive Schwab stream volume held by one state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 303, "OrderFlowState.get_stream_chg_pct", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads the latest Schwab stream change percent held by one state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 311, "OrderFlowState.get_top_of_book_sizes", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads canonical L1 top-of-book sizes from one state instance."),
    Mega2TraceableDerivation("order_flow_live_state.py", 317, "OrderFlowState.get_top_of_book_sizes._to_int", "NONE", None, (), None, "No market-field derivation: nested numeric parse in the canonical state reader."),
    Mega2TraceableDerivation("order_flow_live_state.py", 332, "OrderFlowState.get_stats", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Returns diagnostic state-population counts without recomputing market fields."),
    Mega2TraceableDerivation("order_flow_live_state.py", 345, "push_book", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter to OrderFlowState.push_book."),
    Mega2TraceableDerivation("order_flow_live_state.py", 350, "push_level_one", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter to OrderFlowState.push_level_one."),
    Mega2TraceableDerivation("order_flow_live_state.py", 357, "get_content_for_symbol", "DERIVED", None, ("order_flow_live_state.py:OrderFlowState.get_content_for_symbol",), None, "Thin live-singleton adapter returning canonical engine-facing content."),
    Mega2TraceableDerivation("order_flow_live_state.py", 362, "get_l1_stream_input_probe", "ALLOWLISTED", None, (), 'mega1_l1_sse_counters', "Thin live-singleton adapter to the canonical L1 gate snapshot."),
    Mega2TraceableDerivation("order_flow_live_state.py", 367, "clear_all_live_state", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter that clears canonical session state."),
    Mega2TraceableDerivation("order_flow_live_state.py", 376, "forget_unsubscribed_symbols", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter for subscription-set state cleanup."),
    Mega2TraceableDerivation("order_flow_live_state.py", 381, "get_receive_log", "NONE", None, (), None, "No market-field derivation: thin adapter copying the live receive log."),
    Mega2TraceableDerivation("order_flow_live_state.py", 386, "clear_symbol", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter clearing one symbol."),
    Mega2TraceableDerivation("order_flow_live_state.py", 391, "get_stream_volume", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical stream volume."),
    Mega2TraceableDerivation("order_flow_live_state.py", 396, "get_stream_chg_pct", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical stream change percent."),
    Mega2TraceableDerivation("order_flow_live_state.py", 401, "get_top_of_book_sizes", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical top-of-book sizes."),
    Mega2TraceableDerivation("order_flow_live_state.py", 406, "get_stats", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter returning canonical state diagnostics."),
    ...
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 230, "_replay_new_rows", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Replays daemon-captured L1/book rows into order_flow_live_state/live_market_plane, the same plane-ingest calls the retired direct-socket handlers made (_replay_new_rows)."),
    ...
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 467, "start_order_flow_stream", "DERIVED", None, ("order_flow_live_state.py:get_content_for_symbol",), None, "Delegates to Schwab transport producers for start_order_flow_stream."),
