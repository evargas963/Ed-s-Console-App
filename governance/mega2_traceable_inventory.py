...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("math_exposure_core.py", 468, "pick_pin_and_strength", "DERIVED", None, ("terrain_engine.py:compute_terrain",), None, "RC-124 THE standard gamma pin: the strike with maximum TOTAL gamma (|call GEX$| + |put GEX$|), SpotGamma's Absolute Gamma, plus strength_pct = the leader's margin over the runner-up on the same metric. Hedging MAGNITUDE pins price regardless of net sign. Fail-closed: no dollarized GEX gives (None, None), never a raw-gamma fallback."),
