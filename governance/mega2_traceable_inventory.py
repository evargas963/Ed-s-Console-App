...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("math_levels.py", 345, "consensus_walls_bind_terrain_ssot", "DERIVED", None, ("terrain_engine.py:compute_terrain", "math_levels.py:build_walls_rows",), None, "RC-420: CONSENSUS gamma/delta wall strikes bind to the terrain cache (wide-chain pick_gamma_wall_strikes / pick_delta_wall_strikes); stale or absent terrain withholds rather than leaving selected-expiry analytics in place."),
