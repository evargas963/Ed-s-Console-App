...
MEGA2_TRACEABLE_INVENTORY: tuple[Mega2TraceableDerivation, ...] = (
    ...
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 40, "_safe_float", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_safe_float)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 50, "_nonnegative_float", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_nonnegative_float)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 57, "_safe_int", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_safe_int)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 67, "_collect_from_nested", "NONE", None, (), None, "No market-field derivation: No Schwab market-field derivation in function body."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 83, "_get_nested", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_get_nested)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 98, "_iter_content", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_iter_content)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 110, "_iter_bids_levels", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_iter_bids_levels)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 135, "_iter_asks_levels", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_iter_asks_levels)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 159, "_iter_tape_prints", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_iter_tape_prints)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 183, "_latest_book_snapshot", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_latest_book_snapshot)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 191, "_compute_book_imbalance", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_book_imbalance)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 216, "_latest_quote_snapshot", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_latest_quote_snapshot)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 224, "_compute_top_book_pressure", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_top_book_pressure)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 254, "_resolve_bid_ask_prices", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_resolve_bid_ask_prices)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 278, "_latest_content_field", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "PR214 Gap 1: the ONE freshness-aware per-field resolver over Schwab LEVELONE_OPTIONS/EQUITIES partial/delta content items (_latest_content_field)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 298, "_resolve_quote_mark", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_resolve_quote_mark)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 319, "_compute_spread", "DERIVED", None, ("app/options/order_flow/engine.py:_resolve_quote_mark",), None, "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_spread)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 356, "_compute_tape_pressure", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_tape_pressure)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 410, "_compute_cum_delta_proxy", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_cum_delta_proxy)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 442, "_compute_cum_delta_slope", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_cum_delta_slope)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 501, "_earliest_book_snapshot", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_earliest_book_snapshot)."),
    # RETIRED (mission TRUTH_V1, RC-474): _compute_absorption DELETED (whole-buffer density mislabeled absorption).
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 545, "_iter_option_exp_levels", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_iter_option_exp_levels)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 606, "_option_contract_volume", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_option_contract_volume)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 619, "_compute_options_flow", "DERIVED", None, ("app/options/order_flow/engine.py:_iter_option_exp_levels", "app/options/order_flow/engine.py:_option_contract_volume",), None, "Options flow from chain/stream maps."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 686, "_compute_rvol", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_rvol)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 740, "_compute_institutional_flow_proxy", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_compute_institutional_flow_proxy)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 766, "_normalize", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_normalize)."),
    # RETIRED (mission TRUTH_V1, RC-474): _compute_order_flow_score / _direction / _readiness DELETED with the composite.
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 799, "_weighted_mean_present", "DERIVED", None, ("app/options/order_flow/engine.py:OrderFlowEngine.compute",), None, "Composite mean over present legs only — derives order_flow composite from Schwab-derived inputs (_weighted_mean_present)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 837, "OrderFlowEngine.compute", "DERIVED", None, ("app/options/order_flow/state.py:get_content_for_symbol",), None, "Public OF engine entry; composes sub-metrics."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 992, "OrderFlowEngine._empty_result", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (OrderFlowEngine._empty_result)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 1046, "_mock_data", "ALLOWLISTED", None, (), 'mega2_test_fixture', "Order-flow metric from Schwab stream/quote fields."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 1144, "_main", "NONE", None, (), None, "No market-field derivation: CLI/mock/diagnostic; no production derivation."),
    # ORDER_FLOW_MARKET_MICROSTRUCTURE_V1 (RC-445/446/447): canonical book-microstructure faucet.
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 225, "_book_side_depth_total", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_side_depth_total)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 235, "_book_imbalance_from_totals", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_imbalance_from_totals)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 443, "_sorted_valid_levels", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_sorted_valid_levels)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 453, "_extract_canonical_book", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_extract_canonical_book)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 482, "_canonical_book_identity", "NONE", None, (), None, "No market-field derivation: hashable cache-identity over the extracted canonical book for carry invalidation."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 495, "_microprice", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_microprice)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 515, "_book_pressure_curve", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_pressure_curve)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 525, "_book_slope", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_slope)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 541, "_book_concentration", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_concentration)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 552, "_book_wall_candidates", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_book_wall_candidates)."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 576, "_microstructure_structural", "DERIVED", None, ("app/options/order_flow/engine.py:_book_side_depth_total", "app/options/order_flow/engine.py:_microprice", "app/options/order_flow/engine.py:_book_wall_candidates",), None, "Structural book microstructure: depth totals, imbalance, microprice, slope, concentration and wall candidates from one canonical book snapshot."),
    Mega2TraceableDerivation("app/options/order_flow/engine.py", 662, "compute_book_microstructure", "DERIVED", None, ("app/options/order_flow/engine.py:_extract_canonical_book", "app/options/order_flow/engine.py:_microstructure_structural",), None, "Canonical book microstructure producer: extracts the book once, carries structural state per book identity, stamps ages; the API route serializes it."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 28, "is_rth_open", "ALLOWLISTED", None, (), 'mega1_session_calendar', "No Schwab market-field derivation in function body."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 44, "OrderFlowState.__init__", "NONE", None, (), None, "No market-field derivation: allocates one isolated state container and lock."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 67, "OrderFlowState._get_book", "NONE", None, (), None, "No market-field derivation: bounded book-deque accessor owned by the canonical state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 73, "OrderFlowState._get_tape", "NONE", None, (), None, "No market-field derivation: bounded tape-deque accessor owned by the canonical state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 79, "OrderFlowState._get_receive_log", "NONE", None, (), None, "No market-field derivation: local receive-log deque accessor; not a native trade id."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 85, "OrderFlowState.push_book", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Canonical state transition for a Schwab stream book observation."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 104, "OrderFlowState.push_level_one", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Canonical partial-field, freshness, and tape transition for a Schwab LEVEL_ONE observation."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 214, "OrderFlowState.get_content_for_symbol", "DERIVED", None, ("app/options/order_flow/state.py:OrderFlowState.push_level_one", "app/options/order_flow/state.py:OrderFlowState.push_book",), None, "Canonical engine-facing content derived from one isolated state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 227, "OrderFlowState.get_l1_stream_input_probe", "ALLOWLISTED", None, (), 'mega1_l1_sse_counters', "Cheap L1 gate snapshot from the canonical state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 243, "OrderFlowState.clear_all", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears one state instance so prior-session identity cannot bind a new session."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 248, "OrderFlowState._clear_all_session_state_unlocked", "NONE", None, (), None, "No market-field derivation: lock-held state-container wipe helper."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 263, "OrderFlowState.forget_unsubscribed_symbols", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears canonical state for symbols leaving a subscription set."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 271, "OrderFlowState.get_receive_log", "NONE", None, (), None, "No market-field derivation: copies the local receive-sequence log."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 279, "OrderFlowState.clear_symbol", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Clears every canonical state component for one symbol."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 295, "OrderFlowState.get_stream_volume", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads the latest positive Schwab stream volume held by one state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 303, "OrderFlowState.get_stream_chg_pct", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads the latest Schwab stream change percent held by one state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 311, "OrderFlowState.get_top_of_book_sizes", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Reads canonical L1 top-of-book sizes from one state instance."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 317, "OrderFlowState.get_top_of_book_sizes._to_int", "NONE", None, (), None, "No market-field derivation: nested numeric parse in the canonical state reader."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 332, "OrderFlowState.get_stats", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Returns diagnostic state-population counts without recomputing market fields."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 345, "push_book", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter to OrderFlowState.push_book."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 350, "push_level_one", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter to OrderFlowState.push_level_one."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 357, "get_content_for_symbol", "DERIVED", None, ("app/options/order_flow/state.py:OrderFlowState.get_content_for_symbol",), None, "Thin live-singleton adapter returning canonical engine-facing content."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 362, "get_l1_stream_input_probe", "ALLOWLISTED", None, (), 'mega1_l1_sse_counters', "Thin live-singleton adapter to the canonical L1 gate snapshot."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 367, "clear_all_live_state", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter that clears canonical session state."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 376, "forget_unsubscribed_symbols", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter for subscription-set state cleanup."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 381, "get_receive_log", "NONE", None, (), None, "No market-field derivation: thin adapter copying the live receive log."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 386, "clear_symbol", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter clearing one symbol."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 391, "get_stream_volume", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical stream volume."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 396, "get_stream_chg_pct", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical stream change percent."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 401, "get_top_of_book_sizes", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter reading canonical top-of-book sizes."),
    Mega2TraceableDerivation("app/options/order_flow/state.py", 406, "get_stats", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Thin live-singleton adapter returning canonical state diagnostics."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 113, "_read_daemon_upstream_health", "ALLOWLISTED", None, (), 'mega1_diagnostic_log', "FRESHNESS/HEALTH SEMANTIC AUDIT 2026-08-30: reads the canonical daemon's own status file (stream_spine.HealthRegistry via tools/run_stream_capture.py's write_status) for the REAL per-service Schwab-socket truth, distinct from this module's local-replay-proxy streaming_healthy (_read_daemon_upstream_health)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 140, "_log_stream", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_log_stream)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 148, "_streaming_healthy", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (_streaming_healthy)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 159, "is_order_flow_stream_running", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (is_order_flow_stream_running)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 163, "get_plane_authority_for_ticker", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (get_plane_authority_for_ticker)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 180, "streaming_l1_cache_usable", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Fast-quote gate: plane row fresh within FAST_QUOTE_STREAM_CACHE_MAX_AGE_MS (streaming_l1_cache_usable)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 200, "_stream_db_identity_status", "ALLOWLISTED", None, (), 'mega1_diagnostic_log', "PR214 Gap 2: producer identity via the shared data plane -- reads the daemon's stream_producer_heartbeat row through this process's own resolved stream_capture.db connection, proving identity structurally rather than by comparing two independently-resolved path strings (_stream_db_identity_status)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 490, "begin_option_contract_command", "NONE", None, (), None, "No market-field derivation: PR214 premerge gap 2 -- issues a monotonic generation number so a superseded option-subscription command cannot overwrite newer desired state (begin_option_contract_command)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 577, "_read_producer_option_contracts", "ALLOWLISTED", None, (), 'mega1_diagnostic_log', "PR214 premerge gap 1A: PRODUCER-side option subscription identity -- the current OPEN coverage epoch symbol per Schwab option service, read from the canonical stream_capture.db, distinct from the server's DESIRED/requested contract (_read_producer_option_contracts)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 190, "get_streaming_diagnostics", "ALLOWLISTED", None, (), 'mega1_diagnostic_log', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (get_streaming_diagnostics)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 245, "_identity_forces_unhealthy", "NONE", None, (), None, "No market-field derivation: pure fail-closed gating over an already-computed stream_db_identity verdict plus the existing subscribe-grace window (_identity_forces_unhealthy)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 214, "_open_capture_db_readonly", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "SINGLE-STREAM-AUTHORITY repair 2026-08-30: read-only capture-DB handle for the live-plane feed, replacing the retired second StreamClient (_open_capture_db_readonly)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 230, "_replay_new_rows", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Replays daemon-captured L1/book rows into app.options.order_flow.state/live_market_plane, the same plane-ingest calls the retired direct-socket handlers made (_replay_new_rows)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 271, "_replay_option_contract_rows", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Same replay shape as _replay_new_rows for the one active option contract's LEVELONE_OPTIONS/OPTIONS_BOOK rows (_replay_option_contract_rows)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 309, "_feed_loop", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Poll loop replacing the retired StreamClient message loop; opens zero Schwab connections (_feed_loop)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 452, "_contract_matches_underlying", "NONE", None, (), None, "No market-field derivation: exact vendor OSI-root identity of an already-selected vendor contract symbol against the active underlying."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 556, "clear_active_option_contract", "NONE", None, (), None, "No market-field derivation: drops desired option-contract state and writes an empty daemon signal so a foreign contract cannot survive an underlying switch (clear_active_option_contract)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 461, "_ensure_default_option_contract_for_ticker", "NONE", None, (), None, "No market-field derivation: requests the server-owned default vendor contract; pick lives in app.options.contracts.default."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 356, "set_streaming_active_ticker", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (set_streaming_active_ticker)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 379, "set_active_option_contract", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Requests LEVELONE_OPTIONS/OPTIONS_BOOK for one option contract via the daemon signal file (set_active_option_contract)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 404, "get_option_contract_book_microstructure", "DERIVED", None, ("app/options/order_flow/engine.py:compute_book_microstructure",), None, "Order-flow semantic product for one option contract's live book — delegates to the SAME producer the equity route reads, never a second book-imbalance computation (get_option_contract_book_microstructure)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 419, "_option_streaming_healthy", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "FRESHNESS/HEALTH 2026-08-30: same feed-connection health gate as _streaming_healthy, mirrored for the independent option-contract slot (_option_streaming_healthy)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 431, "get_option_contract_streaming_diagnostics", "ALLOWLISTED", None, (), 'mega1_diagnostic_log', "FRESHNESS/HEALTH 2026-08-30: same diagnostics shape as get_streaming_diagnostics, mirrored for the independent option-contract slot (get_option_contract_streaming_diagnostics)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 467, "start_order_flow_stream", "DERIVED", None, ("app/options/order_flow/state.py:get_content_for_symbol",), None, "Delegates to Schwab transport producers for start_order_flow_stream."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 494, "stop_order_flow_stream", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (stop_order_flow_stream)."),
    Mega2TraceableDerivation("app/options/order_flow/streaming.py", 511, "get_stream_thread", "ALLOWLISTED", None, (), 'mega2_schwab_stream_l1', "Schwab LEVEL_ONE/stream book fields ingested via streaming adapter (get_stream_thread)."),
