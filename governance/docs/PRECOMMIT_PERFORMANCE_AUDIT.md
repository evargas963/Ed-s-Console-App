...
| mission-authorization-prepush | 1 | pre-push | — | True | precommit |
| prepush-parity-gate | 1 | pre-push | — | True | precommit |
| mission-authorization-precommit | 1 | pre-commit | — | True | precommit |
...
| market-correctness | 1 | pre-commit | — | True | precommit |
