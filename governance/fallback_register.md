...
| N-10 | server.py _fetch_state | bid/ask/sizes/mark from a per-cycle REST quote while spot is streamed -- two sources and two instants in one persisted row | snapshots, The Call inputs | FIXED (this PR) |
