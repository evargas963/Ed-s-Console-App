...
| E-34 | 2026-07-28 | DUAL_SOURCE | Two EM books: analytics kl_em (straddle/IV) and terrain implied_1d_move (ATM sigma) both render - different methods, both labeled, but the same CONCEPT twice | SELF (RC-122 sweep) | one EM concept per screen or explicit method labels on both surfaces | OPEN - decide merge vs label |
