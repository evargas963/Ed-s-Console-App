...
ROWS: tuple[Row, ...] = (
    ...
    Row(
        file='app/options/order_flow/engine.py', derivation='_compute_book_imbalance', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/engine.py', derivation='_earliest_book_snapshot', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/engine.py', derivation='_get_nested', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/engine.py', derivation='_iter_tape_prints', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/state.py', derivation='get_l1_stream_input_probe', disposition='ALLOWLISTED',
    ...
    Row(
        file='app/options/order_flow/state.py', derivation='get_top_of_book_sizes', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/streaming.py', derivation='get_stream_thread', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/streaming.py', derivation='is_order_flow_stream_running', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        file='app/options/order_flow/streaming.py', derivation='streaming_l1_cache_usable', disposition='ALLOWLISTED',
        allowlist_id='mega2_schwab_stream_l1',
    ...
    Row(
        ...
        # moved out of server.py into terrain_refresh.py.
        file='terrain_refresh.py', derivation='_terrain_refresh_one', disposition='DERIVED',
    ...
    Row(
        file='app/api/routes/market_data.py', derivation='get_bars1m', disposition='DERIVED',
        producer_refs=('server.py:_fetch_state',),
    ...
    Row(
        file='app/api/routes/market_data.py', derivation='get_forces', disposition='ALLOWLISTED',
        allowlist_id='mega1_sqlite_internal',
    ...
    Row(
        # RC-REHAB-1 (2026-09-23, module extraction, twenty-fourth slice):
        # project_gamma_surface moved out of server.py into gamma_surface_projection.py.
        # _filter_contracts_by_selected_expiry stays in server.py (another caller elsewhere).
        file='gamma_surface_projection.py', derivation='project_gamma_surface', disposition='DERIVED',
