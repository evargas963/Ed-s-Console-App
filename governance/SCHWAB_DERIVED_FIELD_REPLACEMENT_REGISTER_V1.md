...
| Day 1.5 OHLCV pattern repo-wide | DFR-009/011/018/MT-006/007/PQ-009/010 repo-wide | CLOSED | `978d4d5` — pattern swept across 11-file initial finding; `bucket_metric()`; ALLOWLIST in `test_ohlcv_schwab_first.py` |
