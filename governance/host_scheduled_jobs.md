...
| `EdConsole Stream Capture Watchdog` | Every 1 min | `<REPO>\.venv\Scripts\pythonw.exe <REPO>\tools\ensure_stream_capture.py` | stdout JSON `already_running`/`started` | 2026-09-03 — 5-min tick retired; 30s heartbeat TTL needs a 1-min host poll |
