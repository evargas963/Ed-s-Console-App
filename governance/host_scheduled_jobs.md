...
| `EdConsole Stream Capture Watchdog` | Every 5 min | `<REPO>\.venv\Scripts\pythonw.exe <REPO>\tools\ensure_stream_capture.py` | stdout JSON `already_running`/`started` | 2026-09-03 — registered with duration-0 daemon |
