...
| **C-UI-10** | L4572–4631 | “**actionableNow**” combines tradeable + validation + liveReady | trade signal | **PARTIAL** | I-15 | Prefix “UI heuristic — not order router” |
| **C-UI-11** | L4637–4641 `active_compliant` | “**OK (active artifacts compliant)**” / “**DEGRADED**” | governed | **PARTIAL** | verify vs runtime split | Align with G3-R1 resolution |
