> **Classification:** Policy Specification | **Scope:** Governance documentation `Framework-ED-Decision-Engine-v1.1.md`.

# Framework: ED Institutional Decision Engine

**Document ID:** `docs/Framework-ED-Decision-Engine-v1.1.md`  
**Version:** 1.1  
