...
- liquidity: **`liquidity_summary` dict only** (`absorption_score`, `continuation_score`).
...
def build_live_mvp_feature_row(l1_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    out = {
        ...
        "liquidity.absorption_score": read_optional_float(
            liq, "absorption_score", "liquidity.absorption_score"
        ),
        "liquidity.continuation_score": read_optional_float(
            liq, "continuation_score", "liquidity.continuation_score"
        ),
    }
