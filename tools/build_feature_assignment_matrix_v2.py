...
GROUPS = [
    ...
    ("microstructure", "Microstructure derived", "spread, smart_money_score (absorption/continuation WITHHELD RC-455)",
     "Derived (spread=Schwab bid/ask; scores=composites)", "spread 100%; false absorption identity withheld", "XGB",
     A({"1c": "TEST", "5c": "TEST", "15c": "TEST", "60c": "DROP"}),
     "[RESEARCH] spread=liquidity/cost; range×imbalance stall/push is display-only until admitted.",
     "[FACT] historical absorption/continuation is a false identity (RC-455) and is withheld from the serving cone."),
...
CURSOR_VERDICTS: dict[str, tuple[str, str]] = {
    ...
    "microstructure": ("Agree", "spread KEEP short horizons; absorption/continuation withheld (RC-455)."),
