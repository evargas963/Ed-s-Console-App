...
# Binding gate order after ablation confirm v2 (TRAINING_AND_MAINTENANCE.md §Feature placement matrix).
...
_REQUIRED_GATE_SURFACE = (
    ...
    (REPO_ROOT / "TRAINING_AND_MAINTENANCE.md", "stack refit backtest"),
    (REPO_ROOT / "TRAINING_AND_MAINTENANCE.md", "run_survivor_stack_refit_backtest"),
